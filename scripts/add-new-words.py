...
# Path to the existing words.json
...
existing_count = len(data['words']['easy']) + len(data['words']['medium']) + len(data['words']['hard'])
print(f"Existing words: {existing_count}")

# New words to add - all 150 words organized by difficulty
new_words = {
    "easy": [
        # 24 nature_weather easy (removed כפור)
...
print("Due to the large file size, I'll create a script that Python can run to add the words.")
print("The words are ready to be integrated!")
